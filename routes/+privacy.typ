...
#show: html-shim.with(title: "Privacy policy")

We do not collect your data, except for core web vitals and analytics provided
by #link("https://www.simpleanalytics.com/")[Simple Analytics] and
...
with the EU#(apostrophe)s #smallcaps[gdpr].
