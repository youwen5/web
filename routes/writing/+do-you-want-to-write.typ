...
So I built a #link("https://blog.youwen.dev", newtab: true)[blog using
  Haskell]. Because actually, I couldn#(apostrophe)t write in the first one---it
was written with web technologies and that#(apostrophe)s not hipster enough.
...
#link("https://practicaltypography.com/valkyrie.html", newtab: true)[\$119
  font]. Because actually, I couldn#(apostrophe)t write in the other one---since
it used Markdown, and I preferred to write in Typst.

And now I#(apostrophe)m finally writing. After two previous posts about the
engineering that went into website so I could write in it, I can finally
write---about wanting to write.

#dinkus

If I really wanted to write, I#(apostrophe)d just have a Substack. Or
Medium---and if those weren#(apostrophe)t indie enough, I#(apostrophe)d have
