...
impl Template for MainPage {
    fn render_page_with_content(
        ...
        .render_with_children(maud! {
            div id="typst-injected" class="prose-xl lg:prose-2xl mt-2 prose-headings:all-smallcaps prose-headings:text-center prose-h1:text-4xl lg:prose-headings:text-start lg:prose-h1:text-[2.5rem]" {
