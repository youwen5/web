...
impl Template for Prose {
    fn render_page_with_content(
        ...
        .render_with_children(maud! {
            ...
            div id="typst-injected" class="prose-xl mt-8 prose-headings:all-smallcaps prose-headings:text-center lg:prose-headings:text-start prose-headings:text-2xl prose-headings:font-bold prose-headings:dark:font-normal" {
                (content)
            }
