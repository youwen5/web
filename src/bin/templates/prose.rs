...
impl Template for Prose {
    fn render_page_with_content(
        ...
        .render_with_children(maud! {
            ...
            div id="typst-injected" class="prose-lg xl:prose-xl mt-8 prose-headings:all-smallcaps prose-headings:text-lg prose-headings:text-love lg:prose-headings:text-xl" {
