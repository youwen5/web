...
impl Template for Prose {
    fn render_page_with_content(
        ...
        .render_with_children(maud! {
            ...
            div id="typst-injected" class="prose-base md:prose-lg mt-8 prose-headings:all-smallcaps prose-headings:text-lg prose-headings:text-love prose-list-snazzy prose-p:text-[1.1em] prose-headings:mb-1" {
